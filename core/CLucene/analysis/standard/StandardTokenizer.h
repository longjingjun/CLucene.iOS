 ...
 */
  ...
  private:
    ...
    Token* processPunctuation(CL_NS(util)::StringBuffer *str, Token* t, int ch);
      
    //Fill string in the str without using ReadhChar.
    CL_NS(util)::StringBuffer getFollowingStringWithoutReadChar();
      
    bool hasDigit(CL_NS(util)::StringBuffer *str);
